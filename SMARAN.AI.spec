...
binaries = []
hiddenimports = ['app.main', 'app.companion', 'app.app_lock', 'app.web_intents', 'app.analytics_config', 'app.password_policy', 'app.updates', 'app.desktop_agent', 'app.plugin_routes', 'app.local_engine', 'app.mcp', 'app.mcp.client', 'app.mcp.manager', 'app.mcp.routes', 'app.video', 'app.video.hardware', 'app.video.registry', 'app.video.planner', 'app.video.routes', 'app.video.install', 'app.imaging', 'app.imaging.registry', 'app.imaging.engine', 'app.imaging.routes', 'app.media', 'app.media.extract', 'app.media.routes', 'app.capability', 'app.tts', 'app.tts.kokoro', 'app.workspace', 'app.workspace.core', 'app.workspace.routes', 'app.office', 'app.office.documents', 'app.office.messaging', 'app.office.contacts', 'app.office.routes', 'app.voice_local', 'app.voice_local.engine', 'app.voice_local.routes', 'win32com', 'win32com.client', 'pythoncom', 'pywintypes', 'onnxruntime', 'g2p_en', 'segno', 'uvicorn.logging', 'uvicorn.loops.auto', 'uvicorn.protocols.http.auto', 'uvicorn.protocols.websockets.auto', 'uvicorn.lifespan.on', 'webview', 'webview.platforms.winforms', 'edge_tts', 'passlib.handlers.bcrypt', 'sqlalchemy.dialects.sqlite', 'email_validator']
