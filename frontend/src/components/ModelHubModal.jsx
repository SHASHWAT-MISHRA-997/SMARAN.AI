...
const CLOUD_PROVIDERS = [
  ...
  cloudProvider({ id: 'together', name: 'Together AI', color: 'from-blue-600/20 via-indigo-600/10 to-blue-950/40 border-blue-500/40 text-blue-400', getKeyUrl: 'https://api.together.ai/settings/api-keys', placeholder: 'tg_...' }),
