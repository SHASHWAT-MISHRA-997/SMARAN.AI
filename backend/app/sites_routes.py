...
def _render(name: str, prompt: str) -> str:
...
def _write_version(site: dict, prompt: str) -> None:
    ...
    content = _render(site["name"], prompt)
    ...
    site.update(prompt=prompt, version=version, updated_at=_now())
