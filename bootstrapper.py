...
# ─── NEMOTRON GGUF CONFIG ──────────────────────────────────────────────────────
# Nemotron Nano 12B V2 is NOT on Ollama officially.
# We auto-download the GGUF from HuggingFace (bartowski) and import it into Ollama.
# This runs automatically on first boot when 14GB+ VRAM is detected.
NEMOTRON_OLLAMA_TAG  = "nemotron-nano-12b-v2"
NEMOTRON_HF_REPO     = "bartowski/nvidia_NVIDIA-Nemotron-Nano-12B-v2-GGUF"
NEMOTRON_GGUF_FILE   = "nvidia_NVIDIA-Nemotron-Nano-12B-v2-Q6_K_L.gguf"  # ~10.8 GB, excellent quality for 16GB VRAM
NEMOTRON_GGUF_URL    = f"https://huggingface.co/{NEMOTRON_HF_REPO}/resolve/main/{NEMOTRON_GGUF_FILE}"
NEMOTRON_GGUF_PATH   = "/app/data/nemotron-nano-12b-v2.gguf"

PREFERRED_MODELS = [
    # ─── ULTRA TIER: 14GB+ VRAM — Qwen 3 VL 4B / Vision ──────────────────────
    {
        "min_vram_gb":  12.0,
        "min_ram_gb":   16.0,
        ...
        "ctx_window":   32768,
        "reasoning":    True,
        "description":  "Qwen 3 VL 4B — Advanced vision-language model for multimodal document and image understanding."
    },
    # ─── MID TIER: 6-12GB VRAM — Nemotron-3 Nano 4B ──────────────────────────
    {
        "min_vram_gb":  5.5,
        "min_ram_gb":   16.0,
        "ollama_tag":   "nemotron-mini:4b",
        "display_name": "Nemotron-3 Nano 4B (NVIDIA Instruct)",
        "ctx_window":   131072,
        "reasoning":    True,
        "description":  "NVIDIA Nemotron-3 Nano 4B — Ultra-efficient instruction tuned model optimized for GPU inference."
    },
    # ─── CPU / STANDARD TIER: 0-6GB VRAM — Qwen 3 8B ────────────────────────
    {
        "min_vram_gb":  0.0,
        "min_ram_gb":   8.0,
        "ollama_tag":   "qwen3:8b",
        ...
        "ctx_window":   131072,
        "reasoning":    True,
        "description":  "Qwen 3 8B — Powerful reasoning and knowledge engine for general queries."
    }
]
