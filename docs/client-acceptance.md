...
| Website and release assets | Prior 2.10.53 publication is recorded above. Website at https://smaran-ai.netlify.app confirmed live (HTTP 200, 74,222 bytes) on 17 September 2026. v2.10.54 tagged and pushed with persona/language/mobile/companion fixes. Cross-platform runtime parity is not established by CI packaging alone. |
